...
class Sidebar(ctk.CTkFrame):
    ...
    def __init__(
        self, parent, on_page_changed: Optional[Callable[[str], None]] = None, **kwargs
    ):
    ...
    def _build_ui(self):
        ...
        self.task_label = ctk.CTkLabel(
            sidebar_content, text=t("sidebar_task"), font=heading_font(weight="bold")
        )
        ...
        self.settings_label = ctk.CTkLabel(
            sidebar_content, text=t("sidebar_settings"), font=heading_font(weight="bold")
        )
