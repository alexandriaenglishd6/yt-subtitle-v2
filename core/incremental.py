...
class IncrementalManager:
    ...
    def filter_unprocessed(
        ...
        if skipped_count > 0:
            logger.info_i18n("incremental_skip_processed", skipped=skipped_count, remaining=len(unprocessed))
        ...
        for old_path in old_locations:
            if old_path.exists() and old_path.is_file():
                try:
                    ...
                    logger.warning_i18n("archive_migration_failed", path=str(old_path), error=str(e))
