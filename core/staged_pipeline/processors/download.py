...
class DownloadProcessor:
    ...
    def process(self, data: StageData) -> StageData:
        ...
        try:
            ...
            logger.info_i18n(
                "download_subtitle", video_id=vid, title_preview=title_preview
            )
            ...
            downloader = SubtitleDownloader(
                proxy_manager=self.proxy_manager, cookie_manager=self.cookie_manager
            )
            ...
            if not download_result.get("original"):
                ...
                if not self.dry_run:
                    ...
                    data.skip_reason = translate_log(
                        "download_original_subtitle_failed_dry_run"
                    )
            ...
            app_error = AppException(
                message=translate_log(
                    "log.download_subtitle_failed", video_id=vid, error=str(e)
                ),
